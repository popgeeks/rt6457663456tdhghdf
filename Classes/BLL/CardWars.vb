Public Class CardWars
    ...
    Private Sub cardwars_endgame(ByVal socket As Integer)
        ...
        Try
            ...
            If oCardWars.TimeOut < Date.Now Then
                ...
                Send(String.Empty, "CARDWARSCLOSE", GetSocket(Tables(iTableID).Player1))
                Send(String.Empty, "CARDWARSCLOSE", GetSocket(Tables(iTableID).Player2))
    ...
    Private Sub GameOver(ByVal oTable As Entities.BusinessObjects.Tables, ByVal sWinner As String, ByVal sLoser As String, ByVal iWinningScore As Integer, ByVal iLosingScore As Integer, ByVal iGameID As Integer, ByVal bSurrender As Boolean, ByVal bDraw As Boolean)
        ...
        Try
            ...
            If bSurrender = True Then
                Call blockchat(String.Empty, "Surrender", String.Concat(sLoser, " surrendered and lost."), GetSocket(oTable.Player1))
                Call blockchat(String.Empty, "Surrender", String.Concat(sLoser, " surrendered and lost."), GetSocket(oTable.Player2))
            End If
            ...
            Send(String.Empty, "CARDWARSCLOSE", GetSocket(oTable.Player1))
            Send(String.Empty, "CARDWARSCLOSE", GetSocket(oTable.Player2))
    ...
    Private Sub SendCardWarsBoard(ByVal oTable As Entities.BusinessObjects.Tables, ByVal oCardWars As Entities.GameObjects.CardWars)
        Send(String.Empty, String.Format("CARDWARSBOARD {0} {1} {2} {3} {4} {5} {6} {7} {8}", _
             oCardWars.Offense, oCardWars.Defense, oCardWars.ChainPlayer, oCardWars.ChainCount, oCardWars.ElementField, oCardWars.Player1_HP, oCardWars.Player2_HP, oCardWars.PlayerTurn, oCardWars.Rounds), GetSocket(oTable.Player1))

        Send(String.Empty, String.Format("CARDWARSBOARD {0} {1} {2} {3} {4} {5} {6} {7} {8}", _
            oCardWars.Offense, oCardWars.Defense, oCardWars.ChainPlayer, oCardWars.ChainCount, oCardWars.ElementField, oCardWars.Player1_HP, oCardWars.Player2_HP, oCardWars.PlayerTurn, oCardWars.Rounds), GetSocket(oTable.Player2))
    End Sub
    ...
    Private Sub SendPlayerHand(ByVal oTable As Entities.BusinessObjects.Tables, ByVal oCardWars As Entities.GameObjects.CardWars, ByVal iPlayerID As Integer)
        If iPlayerID = 1 Then
            Send(String.Empty, String.Format("CARDWARSHAND {0} {1} {2} {3} {4} {5}", 1, _
                ...
                oCardWars.Player1Hand.Item(4).Replace(" ", "%20")), GetSocket(oTable.Player1))
        ElseIf iPlayerID = 2 Then
            Send(String.Empty, String.Format("CARDWARSHAND {0} {1} {2} {3} {4} {5}", 2, _
                ...
                oCardWars.Player2Hand.Item(4).Replace(" ", "%20")), GetSocket(oTable.Player2))
        End If
    End Sub
    ...
    Private Sub SendHistory(ByVal oTable As Entities.BusinessObjects.Tables, ByVal oCardWars As Entities.GameObjects.CardWars)
        Try
            ...
            For Each oDataRow As DataRow In oDataTable.Rows
                Send(String.Empty, String.Format("CARDWARSHISTORY {0}", oDataRow.Item("Results").ToString.Replace(" ", "%20")), GetSocket(oTable.Player1))
                Send(String.Empty, String.Format("CARDWARSHISTORY {0}", oDataRow.Item("Results").ToString.Replace(" ", "%20")), GetSocket(oTable.Player2))
            Next
        Catch ex As Exception
    ...
    Private Sub SendCardWarsPhase(ByVal oTable As Entities.BusinessObjects.Tables, ByVal sBlueCard As String, ByVal sRedCard As String)
        Try
            Send(String.Empty, String.Format("CARDWARSPHASE {0} {1}", sBlueCard.Replace(" ", "%20"), sRedCard.Replace(" ", "%20")), GetSocket(oTable.Player1))
            Send(String.Empty, String.Format("CARDWARSPHASE {0} {1}", sBlueCard.Replace(" ", "%20"), sRedCard.Replace(" ", "%20")), GetSocket(oTable.Player2))
        Catch ex As Exception
