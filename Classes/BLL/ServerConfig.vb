...
Public Class ServerConfig
    ...
    Public DailyJackpot As Integer
    Public WeeklyJackpot As Integer
        ...
        Try
            ...
            Else
                With oDataRow
                    ...
                    DailyJackpot = .Item("dailyjackpot")
                    WeeklyJackpot = .Item("weeklyjackpot")
            ...
            End If
        Catch ex As Exception
            Call errorsub(ex, "Server Config Loader")
            ErrorDescription = ex
            ErrorFlag = True
        End Try
    End Sub
