Public Class Guilds
    ...
    '        End If
    '    Catch ex As Exception
    '        Call errorsub(ex, "guilddisbandplayer")
    '    End Try
    'End Sub
    ...
    '        End If
    '    Catch ex As Exception
    '        Call errorsub(ex, "guildapproveplayer")
    '    End Try
    'End Sub
    ...
    '        End If
    '    Catch ex As Exception
    '        Call errorsub(ex, "guilddisapproveplayer")
    '    End Try
    'End Sub
    ...
    Private Sub guildinfoupdate(ByRef incoming As String, ByRef socket As Integer)
        Try
            ...
            End If
        Catch ex As Exception
            Call errorsub(ex, "guildinfoupdate")
        End Try
    End Sub
    ...
    '        End If
    '    Catch ex As Exception
    '        Call errorsub(ex, "guildbankcardadd")
    '    End Try
    'End Sub
    ...
    '    Catch ex As Exception
    '        Call errorsub(ex, "guildbankcardremove")
    '    End Try
    'End Sub
    ...
    '        Send(String.Empty, "GUILDBANKREFRESH", socket)
    '    Catch ex As Exception
    '        Call errorsub(ex, "guildbankdepositgold")
    '    End Try
    'End Sub
    ...
    '        Send(String.Empty, "GUILDBANKREFRESH", socket)
    '    Catch ex As Exception
    '        Call errorsub(ex, "guildbankwithdrawgold")
    '    End Try
    'End Sub
