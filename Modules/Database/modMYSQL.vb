...
Module modMYSQL
    Private _IP As String = "192.168.3.11"
    ...
    Public ReadOnly Property PortalConnectionString() As String
        Get
            Return ConfigurationManager.AppSettings("PortalConnectionString").ToString()
        End Get
    End Property

    Public ReadOnly Property TTEConnectionString() As String
        Get
            Return ConfigurationManager.AppSettings("TTEChatString").ToString()
        End Get
    End Property
