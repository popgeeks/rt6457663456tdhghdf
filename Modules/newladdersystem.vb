Module modLaddermodule
        ...
        Try
            ...
            If winnerscore <> loserscore Then
                If bRankFreeze = False Then
                    oGameDAL.RankChange(winner, loser, "TT")
                End If
            End If
    ...
    Public Sub playerrankings(ByRef winner As String, ByRef loser As String, ByRef strGame As String)
        Try
            ...
            'End If
            Dim oGameDAL As New GameFunctionsDAL
            oGameDAL.RankChange(winner, loser, strGame)
        Catch ex As Exception
            Call errorsub(ex, "playerrankings")
        End Try
    End Sub
