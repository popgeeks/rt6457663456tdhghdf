Module modPlayerControl
    Public Sub quit(ByVal incoming As String, ByVal socket As Integer, ByVal bHardQuit As Boolean)
        Try
            ...
            If strCheck = "1" Then
                If itableID > 0 Then
                    Call blockchat(String.Empty, "Error", "You cannot quit while you are still playing a game.  Forcefully ending the application may cause your account to be flagged.", socket)
                    Exit Sub
                Else
