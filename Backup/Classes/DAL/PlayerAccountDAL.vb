...
Public Class PlayerAccountDAL
        ...
        Try
            ...
            If Not (oDataRow Is Nothing) Then
                With oDataRow
                    ...
                    Country = .Item("PlayerCountry").ToString
                    ...
                    AAPct = .Item("aapct")
                    AAExp = .Item("aaexp")
                    LastNewDeck = IIf(IsDBNull(.Item("LastNewDeck")) = True, "1900-01-01", .Item("LastNewDeck"))
                    ...
                    MembershipExpDate = IIf(IsDBNull(.Item("ExpDate")) = True, "1900-01-01", .Item("ExpDate"))
                    ...
                    RushGauge = .Item("Rush")
                    HasShop = IIf(.Item("HasShop") = 1, True, False)
    ...
    Public Sub UpdateExp(ByVal iExp As Integer)
        Try
            ...
            End If
        Catch ex As Exception
            Call errorsub(ex.ToString, "UpdateExp")
        End Try
    End Sub
    ...
    Protected Sub GiveExp(ByVal iExp As Integer, ByVal iAAExp As Integer)
        ...
        Try
            ...
            AAExp += iAAExp
        Catch ex As Exception
            Call errorsub(ex.ToString, "GiveExp")
        Finally
            oServerConfig.MySQLCalls += 1
        End Try
    End Sub
...
Public Property Cash() As String
    ...
    Public Sub SendGold()
        ...
        Catch ex As Exception
            Call errorsub(ex.ToString, "SendGold")
        End Try
    End Sub
End Class
