...
Public Class TTFunctionsDAL
    ...
    Public Function CheckCards() As DataRow
        ...
        Catch ex As Exception
            Call errorsub(ex.ToString, "CheckCards")
            Return Nothing
        Finally
...
Public Property ErrorDescription() As Exception
    ...
    Public Function RandomCards(ByVal sPlayer As String, ByVal iPlayerID As Integer) As Boolean
        Try
            ...
            End If
        Catch ex As Exception
            'Call errorsub(ex.ToString, "RandomCards")
            Return False
        Finally
            oServerConfig.MySQLCalls += 1
        End Try
    ...
    Public Function FullRandomCards(ByVal iPlayerID As Integer) As Boolean
        Try
            ...
            End If
        Catch ex As Exception
            Call errorsub(ex.ToString, "FullRandomCards")
            Return False
        Finally
            oServerConfig.MySQLCalls += 1
        End Try
   ...
   Protected Sub LoadRecord()
    ...
    Protected Sub resetjackpot()
        Try
            Dim oMySqlHelper As New MySQLFactory.MySQLDBHelper
            Dim oDataRow As DataRow = Nothing

            oMySqlHelper.DBExecuteScalar(ConnectionString, CommandType.StoredProcedure, "spu_ResetJackpot")
        Catch ex As Exception
            Call errorsub(ex.ToString, "resetjackpot")
        Finally
