...
Public Class GameFunctions
    ...
    Public Sub KillGame(ByVal iP1Socket As Integer, ByVal iP2Socket As Integer, ByVal sNick As String, ByVal sReason As String)
        ...
        Catch ex As Exception
            Call errorsub(ex.ToString, "killgame")
        End Try
    End Sub
    ...
    Public Sub drawevent(ByVal Player1 As String, ByVal Player2 As String, Optional ByVal gameid As Integer = 0, Optional ByVal blnOTT As Boolean = False, Optional ByVal strGame As String = "", Optional ByVal iGamelength As Integer = 0, Optional ByRef oTTFunctions As TTFunctions = Nothing)
        Try
            ...
            End If
        Catch ex As Exception
            Call errorsub(ex.ToString, "drawevent")
        End Try
    End Sub
    ...
    Public Sub LevelUp(ByVal sName As String, ByVal iLevel As Integer)
        Try
            ...
            Dim levelupgp As Integer = Int(iLevel * (60 + Int(Rnd() * iLevel)))
        ...
        Catch ex As Exception
            Call errorsub(ex.ToString, "LevelUp")
        End Try
    End Sub
    ...
    Public Function APBonus(ByVal sNick As String) As Integer
        Try
            ...
            Return y
        Catch ex As Exception
            Call errorsub(ex.ToString, "APBonus")
        End Try
    End Function
    ...
    Public Function PickStarter(ByVal blnTeam As Boolean) As Integer
        Try
            Randomize()
            Dim intnumber As Integer = Int(Rnd() * 30000) + 1

            Select Case blnTeam
                Case False
                    If intnumber <= 15000 Then
                        Return 1
                    Else
                        Return 2
                    End If
                Case True
                    If intnumber <= 7500 Then
                        Return 1
                    ElseIf intnumber <= 15000 Then
                        Return 2
                    ElseIf intnumber <= 22500 Then
                        Return 3
                    Else
                        Return 4
                    End If
            End Select
        Catch ex As Exception
            Call errorsub(ex.Message, "PickStarter")
            Return 1
        End Try
    End Function
